        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-3xl font-bold text-gray-800">Career Udan</span>
            </div>
          </div>
          <h2 className="text-3xl font-bold text-gray-900 mb-2">
            Start Your BPO Career Journey
          </h2>
          <p className="text-gray-600">
            Join thousands of successful job seekers in the BPO industry
          </p>
        </div>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600">Access to 5000+ BPO jobs</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
              <span className="text-sm text-gray-600">Direct connection with HR teams</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
              <span className="text-sm text-gray-600">Career guidance and support</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
              <span className="text-sm text-gray-600">Resume optimization tips</span>
            </div>
          </div>
        </div>
      </div>
